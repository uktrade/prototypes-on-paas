"""
Django settings for prototypes_router project.
...
# SECURITY WARNING: keep the secret key used in production secret! SECRET I SAY
...
HASHED_PASSWORD = env.str("HASHED_PASSWORD")